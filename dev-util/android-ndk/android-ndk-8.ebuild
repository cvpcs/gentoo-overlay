...
HOMEPAGE="http://developer.a*ndroid.com/sdk/ndk/"
...
# This is an ugly hack to stop portage from crying about QA problems with these prebuilt
# packages
QA_PREBUILT="${ANDROID_NDK_DIR}/*"
