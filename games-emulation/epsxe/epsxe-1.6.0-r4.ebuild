...
DEPEND="${RDEPEND}
	app-arch/unzip"
RDEPEND="${RDEPEND}
	!amd64? ( x11-misc/imake
		games-emulation/psemu-peopsspu
		opengl? ( games-emulation/psemu-gpupetemesagl )
		!opengl? ( games-emulation/psemu-peopssoftgpu ) )
	amd64? ( games-emulation/psemu-peopsspu-bin
		opengl? ( games-emulation/psemu-gpupetemesagl-bin )
		!opengl? ( games-emulation/psemu-peopsoftgpu-bin ) )"
